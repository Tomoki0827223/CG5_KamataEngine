...
int WINAPI WinMain(_In_ HINSTANCE, _In_opt_ HINSTANCE, _In_ LPSTR, _In_ int) {
	...
	// 頂点シェーダーのコンパイル
	std::wstring vsFilePath = L"Resources/Shader/VS.hlsl";
	hr = D3DCompileFromFile(vsFilePath.c_str(), nullptr, 
	...
	// ピクセルシェーダーのコンパイル
	std::wstring psFilePath = L"Resources/Shader/PS.hlsl";
	hr = D3DCompileFromFile(psFilePath.c_str(), nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "main", "ps_5_0", 
	...
	(&heapProperties, D3D12_HEAP_FLAG_NONE, &resourceDesc, D3D12_RESOURCE_STATE_GENERIC_READ, nullptr, IID_PPV_ARGS(&vertexResource));
	assert(SUCCEEDED(hr));
	...
	vertexData[0] = {0.0f, 1.0f, 0.0f, 1.0f}; // 上
	vertexData[1] = {1.0f, -1.0f, 0.0f, 1.0f}; // 右下
	vertexData[2] = {-1.0f, -1.0f, 0.0f, 1.0f}; // 左下
	// アンマップ
	...
	commandList->IASetInputLayout(0, &inputLayoutDesc);
